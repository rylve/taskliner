...
<!-- Replace with a real screenshot before the first public release if desired. -->
<p align="center"><em>Screenshot placeholder — open <a href="https://taskliner.app">taskliner.app</a> or run locally to try the UI.</em></p>
